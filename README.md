...
# JupyterLab Theme Inspired by Tokopedia

Hello Nakama! Do you work with JupyterLab every single day while scroll at Tokopedia? If so, here I made a simple JupyterLab theme inspired by Tokopedia. Source code & setup instructions can be found on the link below. Hope you like it & let's collaborate if you have a new idea on this theme, PR on its GitHub repo.

- 📁 Source code 

    - Github repo: [JupyterLab Tokopedia Theme](https://github.com/LintangWisesa/JupyterLab_Theme_Tokopedia)

    - Preview:

        ![jupyterlab_tokped](img/jupyterlab_tokopedia.png)
...
- Activate your JupyterLab:
    ...
    $ jupyter lab
    ```
- Go to _Settings > JupyterLab Theme_ then choose *JupyterLab Tokopedia*. Enjoy~ 😇
